    ...
    <section className="py-16 sm:py-20 bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="mb-4 text-4xl sm:text-5xl font-bold">Herkes İçin Sporiy</h2>
          ...
          {userTypes.map((type) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-gray-900 mb-3 text-xl font-semibold">{type.title}</h3>
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#d6ff00]/10 border border-[#d6ff00]/30 rounded-full mb-6">
            ...
            <span className="text-sm text-gray-900 font-medium">Platform Özellikleri</span>
          </div>
          <h2 className="mb-4 text-4xl sm:text-5xl font-bold">Modern Spor Deneyimi</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
