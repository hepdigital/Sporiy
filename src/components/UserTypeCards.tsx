        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div className="group relative bg-black rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-500">
            ...
            <div className="relative p-8 md:p-10 lg:p-12">
              ...
              <div className="aspect-[16/10] rounded-2xl overflow-hidden mb-8 relative">
                ...
                />
                {/* Badge */}
                <div className="absolute top-4 right-4 z-20 px-4 py-2 bg-[#d6ff00] text-black rounded-full text-sm">
                  Antrenörler
                </div>
              </div>
              ...
              <div className="text-white">
                <h2 className="mb-4 text-white">Antrenör Müsün?</h2>
                ...
                <Button 
                  size="lg" 
                  className="w-full bg-[#d6ff00] text-black hover:bg-[#c5ee00] group/btn"
                >
                  <span>KAYIT OL</span>
          ...
          <div className="group relative bg-black rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-500">
            ...
            <div className="relative p-8 md:p-10 lg:p-12">
              ...
              {/* Content */}
              <div className="text-white">
                <h2 className="mb-4 text-white">Sporcu Musun?</h2>
                <p className="text-gray-300 mb-6">
